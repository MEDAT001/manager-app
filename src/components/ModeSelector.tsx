  ...
  return (
    <div className="h-full flex flex-col items-center justify-center px-6 relative overflow-hidden"
      ...
      <div className="relative z-10 text-center" style={{ animation: 'fadeUp 1s cubic-bezier(0.16, 1, 0.3, 1)' }}>
        ...
        <span className="text-[10px] font-semibold tracking-[0.25em] uppercase mt-12 block" style={{ color: '#D4B97A', fontFamily: "'Cormorant Garamond', serif", opacity: 0.6 }}>Version beta</span>
      </div>
    </div>
  )
}
